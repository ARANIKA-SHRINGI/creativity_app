  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(
      ...
      if (status == AnimationStatus.completed) {
        Navigator.push(context, PageTransition(child:  MyHomePage(), type: PageTransitionType.fade));
      }
    });
  }
      ...
      body: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              FadeAnimation(1, Text("Find the best jewellery for your partner.", 
              style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.bold, height: 1.1),)),
              SizedBox(height: 30,),
              FadeAnimation(1.2, Text("Let us find you jewellery for your interest", 
                  ...
                  builder: (context, child) => Transform.scale(
                    ...
                    child: Container(
                      ...
                      child: hide == false ? Row(
                        ...
                        children: <Widget>[
                          Text("Find best jewellery", style: TextStyle(color: Colors.white, fontSize: 17),),
